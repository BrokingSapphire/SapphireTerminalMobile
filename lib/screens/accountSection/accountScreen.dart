  ...
  Widget titleWithSub(String title, String subtitle) {
    return SizedBox(
      ...
      child: ListTile(
        title: Text(
          title,
          style: TextStyle(fontSize: 12.sp, color: Color(0xffC9CACC)),
        ),
        subtitle: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              columnText("Account Number", accountNumber),
              columnText("IFSC Code", ifscCode),
            ],
          ),
          SizedBox(height: 12.h),
          // Branch Details
          columnText("Branch", branch),
        ],
      ),
    );
  }
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            left: 15.w, top: 16.h, bottom: 16.h, right: 16.w),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(
                      ...
                      titleWithSub("PAN", "CRNP00991H"),
                      SizedBox(
                        height: 16.h,
                      ),
                      titleWithSub("Phone", "+91 1234567890"),
                      SizedBox(
                        height: 16.h,
                      ),
                      titleWithSub("Location", "Nagpur, Maharastra"),
                      SizedBox(
                        height: 16.h,
                      ),
                      titleWithSub("Email", "nakul.thakur@sapphirebroking.com"),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      titleWithSub(
                          "Demat Account (BO) ID", "1294892792132487633"),
                      SizedBox(
                        height: 16.h,
                      ),
                      titleWithSub("DP ID", "1294392"),
                      SizedBox(
                        height: 16.h,
                      ),
                      titleWithSub(
                          "Depository Participant (DP)", "Sapphire Broking"),
                      SizedBox(
                        height: 16.h,
                      ),
                      titleWithSub("Depository", "CDSL"),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      columnText("Nominee Name", "Pratap Chandrakant Thakur"),
                      SizedBox(
                        height: 16.h,
                      ),
                      columnText("Document ID", "ACKT8301N"),
                      SizedBox(
                        height: 16.h,
                      ),
                      columnText("Relationship", "Father"),
                      SizedBox(
                        height: 16.h,
                      ),
                      columnText("(%) Share", "50%"),
