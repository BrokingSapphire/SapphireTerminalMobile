...
class PledgeContentContent extends StatefulWidget {
  ...
  const PledgeContentContent({Key? key, this.updateSelectedStock})
      : super(key: key);

  @override
  State<PledgeContentContent> createState() => _PledgeContentContentState();
}

class _PledgeContentContentState extends State<PledgeContentContent> {
