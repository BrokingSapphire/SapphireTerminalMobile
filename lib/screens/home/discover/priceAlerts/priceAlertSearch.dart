...
class PriceAlertSearchScreen extends StatefulWidget {
  const PriceAlertSearchScreen({super.key});

  @override
  State<PriceAlertSearchScreen> createState() => _PriceAlertSearchScreenState();
}

class _PriceAlertSearchScreenState extends State<PriceAlertSearchScreen>
