...
class ClosedComGridScreen extends StatefulWidget {
  ...
  @override
  State<ClosedComGridScreen> createState() => _ClosedComGridScreen();
}

class _ClosedComGridScreen extends State<ClosedComGridScreen> {
  ...
  List<Map<String, String>> get sortedData {
    ...
    if (_sortColumn != null) {
      dataList.sort((a, b) {
        ...
        // Handle integer fields (quantity, duration)
