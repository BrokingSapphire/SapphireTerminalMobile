...
class holdingsBottomSheet extends StatefulWidget {
  ...
  @override
  State<holdingsBottomSheet> createState() => _holdingsBottomSheetState();
}

class _holdingsBottomSheetState extends State<holdingsBottomSheet> {
  ...
  final double _initialChildSize =
      0.45; // Initial size when bottom sheet appears
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(
                  const Color(0xFF1DB954), // Bright green for buy
                ),
        ...
        Expanded(
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(
                  const Color(0xFFFF3B30), // Bright red for sell
                ),
                foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
                elevation: MaterialStateProperty.all<double>(4),
                shape: MaterialStateProperty.all<RoundedRectangleBorder>(
