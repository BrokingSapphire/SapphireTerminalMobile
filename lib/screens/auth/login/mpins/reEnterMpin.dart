...
class ReEnterMpinScreen extends StatefulWidget {
  final String pin;
  const ReEnterMpinScreen({super.key, required this.pin});

  @override
  State<ReEnterMpinScreen> createState() => _ReEnterMpinScreenState();
}

/// State class for the MpinScreen widget
/// Manages PIN input, biometric authentication, and UI rendering
class _ReEnterMpinScreenState extends State<ReEnterMpinScreen> {
